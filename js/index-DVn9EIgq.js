...
const Z = [
  ...
  re = "OmNamahShivaya",
  oe = {
    email: "root@laxmikanta.info",
    github: "github/laxmikanta",
    linkedin: "linkedin/laxmikanta",
  },
  ...
  se = [
    ["Jio-Mart", "Mangaging UAT & DEV infras", "https://www.jiomart.com/"],
    ["Web Application", "E-commerce app Deployement", "https://github.com/devopsdock0125/tws-e-commerce-app_hackathon.git"],
    /*[
      "Hack the SYSTEM",
...
const ie = {
    commands: [
      ...
      ["'projects'", "CI/CD, Cloud & Cool Stuff"],
      ["'whoami'", "Engineer of Code & Infra"],
      ["'sudo'", "Because Sometimes You Just Need Root Access"],
      ["'banner'", "Infrastructure Meets Creativity"],
    //  ["'books'", "Must-Reads for the Savvy"],
      ["'resources'", "DevOps & Security Picks"],
      ["'tools'", "Essential DevOps Toolkit"],
    //  ["'equipment'", "Gear We're Totally Obsessed With"],
      ["'location'", "Usually Between Cloud and On-Prem"],
  ...
  pe = () => {
    ...
    const e = [],
      ...
      G = `<i class='fa-brands fa-github'></i> ${g}`,
      S = `<i class='fa-brands fa-youtube'></i> ${u}`,
    ...
    return (
      ...
      (i += h),
      (i += t.repeat(12)),
      (i += `<a target='_blank' href='mailto:laxmikantag901@gmail.com'>${a.social.email}</a>`),
      e.push(i),
      (i = ""),
      (i += t.repeat(2)),
      (i += y),
      (i += t.repeat(9)),
      (i += `<a target='_blank' href='https://www.linkedin.com/in/laxmikanta-giri/'>${a.social.linkedin}</a>`),
      e.push(i),
      (i = ""),
      (i += t.repeat(2)),
      (i += G),
      (i += t.repeat(11)),
      (i += `<a target='_blank' href='https://github.com/lax66'>${a.social.github}</a>`),
      e.push(i),
      (i = ""),
      (i += t.repeat(2)),
      (i += S),
      (i += t.repeat(10)),
      (i +=
        "<a target='_blank' href='https://www.youtube.com/@DevOpsDock'>YouTube/laxmikanta</a>"), // tryHacker link
      e.push(i),
      (i = ""),
      (i += t.repeat(2)),
      (i += F),
      (i += t.repeat(11)),
      (i += "<a target='_blank' href='LaxmikantaGiri_DevOpsEngineer_SRE.pdf' download>Download</a>"),
      e.push(i),
      e.push("<br>"),
      e
    );
  ...
  R = {
    ...
    message: [
      [
        "Up in the cloud, I build and fix,",
        "turning chaos into clean pipelines.",
        "I’m the engineer who makes things just… work - ",
      ],
      [
        "I talk to clusters and they listen.",
        "With my tools, I deploy fast, scale smooth, and keep it running - ",
      ],
      [
        "I’ve battled bugs and broken builds,",
        "a guardian of uptime and speed.",
        "My pipelines run as quick as my coffee kicks in - ",
      ],
      [
        "Scaling servers or climbing peaks,",
        "I like a good challenge both ways.",
        "From code to cloud, I keep things flowing - ",
      ],
      [
        "In the world where apps crash and rise,",
        "I rule with scripts and automation.",
        "My kingdom is the cloud, my crown is CI/CD,",
        "and I shape the future with YAML and a smile - ",
      ],
    ]
  ...
  ye = () => {
    const e = [],
      ...
      s = [
        { name: "Linux",url: "https://documentation.ubuntu.com/server/" },
        ...
        { name: "Git", url: "https://git-scm.com/docs" },
        { name: "Ceph", url: "https://docs.ceph.com/en/latest/" },
        { name: "Cisco", url: "https://www.netacad.com/" },
        { name: "Terraform", url: "https://registry.terraform.io/" },
        { name: "Ansible", url: "https://docs.ansible.com/ansible/latest/index.html" },
      ];
    return (
      e.push("<br>"),
  ...
  ke = () => {
    ...
    //------------------tools--------------
      ...
      s = [
        { name: "Linux", description: "Foundation of servers and systems" },
        { name: "Networking", description: "Connecting systems and services" },
        ...
        { name: "Ceph", description: "Distributed storage system" },
        { name: "HAProxy", description: "Load balancer and proxy server" },
        { name: "Cilium", description: "Networking and security for Kubernetes" },
        { name: "BindDNS", description: "DNS server software" },
        { name: "Dotcom Monitor", description: "Performance and uptime monitoring" },
        { name: "Sensu", description: "Monitoring and observability tool" },
        { name: "Python", description: "Programming language for automation" },
        { name: "Bash", description: "Shell scripting for automation" },
        { name: "OpenVPN", description: "Secure VPN solution" },
        { name: "Wireshark", description: "Network protocol analyzer" },
        { name: "Trivy", description: "Container and vulnerability scanner" },
